...
__decorate([
    ...
    (0, swagger_1.ApiCreatedResponse)({ description: 'Room created successfully', type: room_entity_1.Room }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Successfully joined the room', type: room_entity_1.Room }),
    __param(0, (0, common_1.Request)()),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Room ID' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Successfully left the room', type: room_entity_1.Room }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Successfully removed member from room', type: room_entity_1.Room }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Room ID' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Returns list of room members', type: room_members_dto_1.RoomMembersDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Room ID' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Returns room details', type: room_entity_1.Room }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Returns all rooms', type: [room_entity_1.Room] }),
