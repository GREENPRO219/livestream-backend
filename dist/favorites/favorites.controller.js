...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Media favorited successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Media ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Media unfavorited successfully' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Room favorited successfully' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Room ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Room unfavorited successfully' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Favorite not found' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Media ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Favorite toggled successfully', schema: { type: 'object', properties: { favorited: { type: 'boolean' } } } }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns user favorites', type: [favorite_entity_1.Favorite] }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Media ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns the number of favorites', schema: { type: 'object', properties: { count: { type: 'number' } } } }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Media ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns favorite status', schema: { type: 'object', properties: { favorited: { type: 'boolean' } } } }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
